...
class WizardExtendHolidays(models.TransientModel):
    ...
    date_from = fields.Datetime(readonly=True, related="holidays_id.date_from")
    date_to = fields.Datetime()

    number_of_days_temp = fields.Float(compute="_compute_number_of_days_temp")

    holidays_id = fields.Many2one(comodel_name="hr.holidays")
