                ...
                self.$('[data-toggle="popover"]').each(function () {
                    $(this).popover({
                        ...
                        title: function () {
                            ...
                            $title.on(
                                "click",
                                ".o_department_redirect",
                                _.bind(self._ondepartmentRedirect, self)
                            );
                            return $title;
                        },
                        container: "body",
                        ...
                        content: function () {
                            ...
                            $content.on(
                                "click",
                                ".o_department_sub_redirect",
                                _.bind(self._ondepartmentSubRedirect, self)
                            );
                            return $content;
                        },
